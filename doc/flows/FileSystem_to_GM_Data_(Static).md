# File System to Grey Matter Data (Static Permissions)

The template for transferring files from the file system to an instance of Grey Matter Data.

## Template Location

Download template for [Upload File System to Grey Matter Data with Static Permissions](../../nifi-templates/File_System_to_GM_Data_(Static_Permissions).xml)

## Flow visualization

![File System to GM Data](visualizations/FileSystem_to_GM_Data_(Static).png)
